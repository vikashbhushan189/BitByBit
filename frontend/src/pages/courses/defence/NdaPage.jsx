  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 p-8">
      <div className="max-w-4xl mx-auto bg-white dark:bg-slate-800 p-10 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 text-center">
        ...
        <h1 className="text-3xl font-extrabold text-slate-800 dark:text-white mb-2">NDA Examination Course</h1>
        <p className="text-lg text-slate-500 dark:text-slate-400 mb-6">
          Detailed information, syllabus, and enrollment options for the National Defence Academy (NDA) preparation course will be displayed here.
        </p>
